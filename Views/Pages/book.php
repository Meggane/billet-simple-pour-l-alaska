...
?>
    ...
    <div id="button_create"><a href="../Tickets/insertTicket.php"><button type="button" class="btn btn-primary">Créer un billet</button></a></div>
    ...
    foreach ($ticketList as $ticket) {
        ...
        <div class="tickets">
            ...
            <p class="link_ticket_admin">
                ...
                if (isset($_SESSION["admin"]) && $_SESSION["admin"] == 1) {
                ?>
                    <a id="btn_modify_book" class="btn btn-primary" href="../Tickets/insertTicket.php?id=<?= $ticket->id() ?>">Modifier</a>
