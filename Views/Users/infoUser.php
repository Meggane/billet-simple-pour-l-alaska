...
?>
    ...
    <div id="info_user" class="container-fluid well span6">
        <div class="row-fluid">
            <div class="info_user_presentation col-lg-2 col-sm-3 col-xs-4" >
                <img src="https://image.ibb.co/jw55Ex/def_face.jpg" class="img-circle">
            </div>

            <div class="info_user_presentation col-lg-8 col-sm-6 col-xs-4">
                <h3><?= $_SESSION["login"] ?></h3>
                <h6>Email: <?= $_SESSION["email"] ?></h6>
            </div>

            <div id="info_user_btn_delete_user" class="col-lg-2 col-sm-3 col-xs-4">
